      ...
      <section>
        <div>
          ...
          <ul>
            ...
            <li>
              Teamwork <em>does</em> make the dream work.
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul>
            <li>
              Take a look at my <a href="#projects">projects</a>.
            </li>
            <li>
              Read my <a href="#resume">resume.</a>
            </li>
            <li>
              Then <a href="#contact">contact me</a> and we&#0039;ll get
              started.
            </li>
          </ul>
        </div>
